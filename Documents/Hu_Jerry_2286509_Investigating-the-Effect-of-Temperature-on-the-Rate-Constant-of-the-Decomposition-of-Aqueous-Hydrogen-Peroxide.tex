  ...
  \begin{table}[H]
    ...
    \begin{tabular}{!{\vrule width 1.8pt}
      ...
      >{\centering\arraybackslash}m{3.5cm}|
        ...
        \textbf{Temp / $^\circ \text{C}$ ($\pm 0.5~^\circ\text{C}$)} &
        \textbf{Trial} &
        ...
        \multirow{5}{*}{\textcolor{red}{15}}  & \textcolor{red}{1} & \textcolor{red}{287.90} & \textcolor{red}{0.30} & \textcolor{red}{37.8} & \textcolor{red}{60.0} & \textcolor{red}{$1.40 \cdot 10^{-6}$} & \multirow{5}{*}{\underline{\textcolor{red}{$(1.887\pm0.165) \cdot 10^{-6}$}}} & \multirow{5}{*}{\underline{\textcolor{red}{$3.69 \cdot 10^{-7}$}}} \\ \cline{2-7}
        ...
        \multirow{5}{*}{20}  & 1 & 292.15 & 0.30 & 31.8 & 60.0 & $1.67 \cdot 10^{-7}$ & \multirow{5}{*}{$(1.885\pm0.442) \cdot 10^{-6}$} & \multirow{5}{*}{$9.88 \cdot 10^{-7}$} \\ \cline{2-7}
        ...
        \multirow{5}{*}{25}  & 1 & 298.65 & 0.29 & 29.8 & 60.0 & $3.88 \cdot 10^{-6}$ & \multirow{5}{*}{$(3.390\pm0.285) \cdot 10^{-6}$} & \multirow{5}{*}{$6.37 \cdot 10^{-7}$} \\ \cline{2-7}
        ...
        \multirow{5}{*}{30}  & 1 & 303.25 & 0.33 & 10.0 & 60.0 & $1.10 \cdot 10^{-5}$ & \multirow{5}{*}{$(7.543\pm1.193) \cdot 10^{-6}$} & \multirow{5}{*}{$2.67 \cdot 10^{-6}$} \\ \cline{2-7}
        ...
        \multirow{5}{*}{35}  & 1 & 308.65 & 0.31 & 7.8  & 60.0 & $1.03 \cdot 10^{-5}$ & \multirow{5}{*}{$(8.594\pm0.926) \cdot 10^{-6}$} & \multirow{5}{*}{$2.07 \cdot 10^{-6}$} \\ \cline{2-7}
        ...
        \multirow{5}{*}{40}  & 1 & 313.50 & 0.28 & 11.2 & 60.0 & $9.82 \cdot 10^{-6}$ & \multirow{5}{*}{$(8.886\pm1.208) \cdot 10^{-6}$} & \multirow{5}{*}{$2.70 \cdot 10^{-6}$} \\ \cline{2-7}
        ...
        \multirow{5}{*}{45}  & 1 & 318.40 & 0.29 & 7.0  & 60.0 & $1.14 \cdot 10^{-5}$ & \multirow{5}{*}{$(1.291\pm0.271) \cdot 10^{-5}$} & \multirow{5}{*}{$6.06 \cdot 10^{-6}$} \\ \cline{2-7}
        ...
        \multirow{5}{*}{50}  & 1 & 322.45 & 0.31 & 10.4 & 60.0 & $3.09 \cdot 10^{-5}$ & \multirow{5}{*}{$(1.843\pm0.382) \cdot 10^{-5}$} & \multirow{5}{*}{$8.54 \cdot 10^{-6}$} \\ \cline{2-7}
...
\indent \indent Consider $15\ ^\circ$C trial 1 as an example (marked as \textcolor{red}{red}) in \textit{table \ref{tab:processed-data}}. The average temperature for this trial was:
...
\noindent The standard deviation and the uncertainty in average rate can then be calculated:
...
\begin{equation}
  \Delta{\overline{r}} = \frac{\sigma}{\sqrt{4}} = 1.65 \cdot 10^{-7}\ \text{mol}\ \text{s}^{-1}
\end{equation}
...
\begin{table}[H]
	...
	\begin{tabular}{|>{\centering\arraybackslash}m{4.5cm}|
      ...
      15 & 288.15 & $(1.887 \pm 0.165) \cdot 10^{-6} $ \\ \hline
      20 & 293.15 & $(1.885 \pm 0.442) \cdot 10^{-6}$ \\ \hline
      25 & 298.15 & $(3.390 \pm 0.285) cdot 10^{-6}$ \\ \hline
      30 & 303.15 & $(7.543 \pm 1.193) cdot 10^{-6}$ \\ \hline
      35 & 308.15 & $(8.594 \pm 0.926) cdot 10^{-6}$ \\ \hline
      40 & 313.15 & $(8.886 \pm 1.208) cdot 10^{-6}$ \\ \hline
      45 & 318.15 & $(1.291 \pm 0.271) cdot 10^{-5}$ \\ \hline
      50 & 323.15 & $(1.843 \pm 0.382) cdot 10^{-5}$ \\ \hline
		\end{tabular}
	}
