...
\begin{enumerate}
  \item Pour a large amount of aqueous \ce{H2O2} into a clean $600\ \text{mL}$ beaker to use as the master solution for all trials. Excess can be poured back later using a funnel.
