...
\noindent Where $\sigma$ is the standard deviation of the $n=5$ trials. Instrument uncertainty was propagated through the rate calculation:

\begin{equation}
  \Delta{\overline{r}_\text{inst}} = \frac{V_\text{gas}}{RT} \cdot m
\end{equation}
...
\begin{equation}
  \Delta{\overline{r}} = \sqrt{(\Delta{\overline{r}_\text{rand}})^2 + (\Delta{\overline{r}_\text{inst}})^2}
\end{equation}
